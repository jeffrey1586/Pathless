...
public class InputActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLoadImage.setOnClickListener(new View.OnClickListener() {
            ...
            // The onClick that brings the user to the gallery
            @Override
        ...
        // Setting up the autocomplete for places api in the edit text
    ...
    // Puts the correct menu item on the top right of the actionbar
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Post all location information if check icon is clicked
